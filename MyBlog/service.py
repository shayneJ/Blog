...
def articleList(username):
    sql = "SELECT id,a.userId,title,tags,date,a.typeId,type,content,copyfrom,username FROM db_article a LEFT JOIN db_menu b ON a.userId = b.userId WHERE a.username='%s' "% \
            (username)
